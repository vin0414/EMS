...
<html lang="en">
  <head>
    ...
    <title>EMS - Expense Report</title>
    ...
    <div class="container-scroller">
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="<?=site_url('expense-report')?>">
              <i class="mdi mdi-chart-bar menu-icon"></i>
        ...
        <div class="main-panel">
          <div class="content-wrapper pb-0">
            <div class="page-header flex-wrap">
              <h3 class="mb-0"> Hi, welcome back! <span class="pl-0 h6 pl-sm-2 text-muted d-inline-block">Expense Report</span>
              </h3>
              <div class="d-flex">
